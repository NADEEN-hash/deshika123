    ...
    try {
      ...
      for (var _0x3fdb0d = 0; _0x3fdb0d < _0x419390.length; _0x3fdb0d++) {
        _0x52a977.push({
          ...
          description: '',
          rowId: _0x52cdd3 + 'sininfo2 ' + _0x419390[_0x3fdb0d].Link,
        })
      }
      const _0x14e5d4 = [
          {
    ...
    try {
      ...
      const _0x429230 = _0x13f8d3.trim(),
        ...
        _0x1e779c = {
          ...
          fileName: '🎬DINKA🎬' + _0x336ab5 + '.mp4',
        }
       await _0x1c77e5.sendMessage(_0x4a5220, {
        text: '*Uploading your movie..\u2B06️*',
      })
      await _0x1c77e5.sendMessage(config.DINKA, _0x1e779c)
      await _0x1c77e5.sendMessage(_0x4a5220, {
        react: {
          text: '✅️',
          key: _0x4b72bf.key,
  ...
  async (
    ...
    try {
      ...
      const _0xc6d37a = (
        ...
        _0xc6d37a.chlink + 
        '*\n*★━━━━━━━━━━━━━━━━★*\n' +
        '\n\n> _*㋛ 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙽𝙰𝙳𝙴𝙴𝙽 〽️𝙳*_\n'
      await _0x4732ee.sendMessage(config.DINKA, {
    ...
    try {
      ...
      for (var _0x306b90 = 0; _0x306b90 < _0x1cf7c9.length; _0x306b90++) {
        _0x2590ed.push({
          ...
          description: '',
          rowId: _0x1c9914 + 'sintvinfo2 ' + _0x1cf7c9[_0x306b90].Link,
        })
      }
      const _0x57d158 = [
          {
...
cmd(
  ...
  async (
    ...
    try {
      ...
      var _0x5365c3 = []
      _0x5365c3.push({
        buttonId: _0x5ac61c + 'dtaqt2 ' + _0xc43a31,
    ...
    try {
      ...
      const _0x5205ff = _0x1b8dc8.trim(),
        ...
        _0x24615f = {
          ...
          fileName: '🎬DINKA🎬' + _0x1c158b + '.mp4',
        }
      await _0x377d1d.sendMessage(_0x2677f9, {
        text: '*Uploading your movie..\u2B06️*',
      })
      await _0x377d1d.sendMessage(config.DINKA, _0x24615f)
      await _0x377d1d.sendMessage(_0x2677f9, {
        react: {
          text: '\u2714️',
          key: _0xc9855e.key,
    ...
    try {
      ...
      const _0x3673b4 = (
        ...
        _0x2152c3 =
          ...
          _0x3673b4.chlink +
          '*\n\n> _*㋛ 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙽𝙰𝙳𝙴𝙴𝙽 〽️𝙳*_\n'
      await _0x33088a.sendMessage(config.DINKA, {
