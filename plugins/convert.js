  ...
  async (
    ...
    try {
      ...
      let _0x21710a = await fetchJson(
        'https://www.dark-yasiya-api.site/download/mfire?url=' + _0x490e08
      )
      await _0x172337.sendMessage(
        _0x2d28ec,
        {
          document: { url: _0x21710a.result.dl_link },
...
cmd(
  ...
  async (
    ...
    _0xaf632e,
    _0x3fa5b6,
    { from: _0x40fdf1, q: _0x51dd2b, reply: _0x287c17 }
  ) => {
    if (!_0x51dd2b) {
